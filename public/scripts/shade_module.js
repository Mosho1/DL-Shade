...
(function() {
  angular.module('ShadeApp', ['ShadeServices', 'ngGrid', 'mgcrea.ngStrap.popover']).directive('popup', function() {
    return {
      restrict: 'E',
      replace: true,
      scope: false,
  ...
  }).directive('btn', function($compile, $timeout) {
    return {
      restrict: 'C',
      replace: true,
      scope: false,
      ...
      link: function(scope) {
        return scope.popup = function(id, elm) {
          ...
          $timeout(function() {
            return angular.element('#' + id).triggerHandler('popup');
          });
        };
      }
    };
